...
from Cervical.model.autoencoder_tool_cer import set_seed
from Cervical.model.diffusion_tool_cer import  MlpDiffusion, Diffusion, plot_dim_dist

config = {
    'experimentName': 'Cervical',
    'exp_path': '../experiments/Cervical',
    'model_path': '../experiments/Cervical/diffusionModel',
    'data_path': '../data',
    'batch_size': 64,
    'if_shuffle': True,
    'if_drop_last': True,
